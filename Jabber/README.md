...
| Unbekanntes Element auf Stream-Ebene (§4.9.3.24) | ⚠️ Auf der Client-Verbindung folgt `<unsupported-stanza-type/>` und der Stream endet (§4.9.1.1). Auf dem S2S-Stream **nicht**: Was fremde Server dort sonst noch schicken, ist nicht erhoben, und ein Abbruch wäre eine Wette statt einer Messung |
