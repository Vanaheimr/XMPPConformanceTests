...
XEP-0454 — **113 of 113, nothing skipped**, and then repeats the lane against
...
this suite is green at "2 passed, 111 skipped" on a bare runner and green at "113
...
40, 45, 52, 59, 65, 71, 89, 93, 99, 103, 107, 113 so far, and `nightly.yml` carries the history beside the figure together with
...
# The verdict: with Prosody, ejabberd and the oracles up. 113 of 113
dotnet test XMPPConformanceTests/XMPPConformanceTests.csproj
```
