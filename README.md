...
XEP-0454 — **107 of 107, nothing skipped**, and then repeats the lane against
...
this suite is green at "2 passed, 105 skipped" on a bare runner and green at "107
...
40, 45, 52, 59, 65, 71, 89, 93, 99, 103, 107 so far, and `nightly.yml` carries the history beside the figure together with
...
# The verdict: with Prosody, ejabberd and the oracles up. 107 of 107
dotnet test XMPPConformanceTests/XMPPConformanceTests.csproj
```
