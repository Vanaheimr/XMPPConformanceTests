...
XEP-0454 — **65 of 65, nothing skipped**, and then repeats the lane against
...
this suite is green at "2 passed, 63 skipped" on a bare runner and green at "65
...
40, 45, 52, 59, 65 so far, and `nightly.yml` carries the history beside the figure together with
...
# The verdict: with Prosody, ejabberd and the oracles up. 65 of 65
dotnet test XMPPConformanceTests/XMPPConformanceTests.csproj
```
